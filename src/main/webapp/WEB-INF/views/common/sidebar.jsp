<%
    ...
    String currentPage = request.getRequestURI().substring(contextPath.length());

    boolean dashboardActive = currentPage.equals("/dashboard");
    boolean patientsActive = currentPage.startsWith("/patients");
    boolean dentistsActive = currentPage.startsWith("/dentists");
    boolean treatmentsActive = currentPage.startsWith("/treatments");
    boolean appointmentsActive = currentPage.startsWith("/appointments");
    boolean billsActive = currentPage.startsWith("/bills");
    boolean reportsActive = currentPage.startsWith("/reports");
%>
...
<aside class="fixed left-0 top-0 z-50 flex h-screen w-[250px] flex-col bg-[#111827] px-4 py-6">
    ...
    <div>
        ...
        <nav class="space-y-1">
            ...
            >
                <svg class="h-[17px] w-[17px] shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M4 19V5M4 19h17"/>
                    <path stroke-linecap="round" d="M8 16v-5M12 16V7M16 16v-8"/>
                </svg>
    ...
    <div class="mt-auto border-t border-white/[0.06] pt-4">
        ...
        >
            ...
            <svg class="h-[17px] w-[17px]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M10 17l5-5-5-5M15 12H3"/>
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 19V5a2 2 0 00-2-2h-7"/>
            </svg>
