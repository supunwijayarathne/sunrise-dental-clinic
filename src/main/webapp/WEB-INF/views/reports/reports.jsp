    ...
    <div class="mx-auto max-w-[1400px]">
        ...
        <section
            ...
            <div class="print-header mb-6">
                ...
                <h1 class="font-manrope text-2xl font-extrabold">
                    SUNRISE DENTAL
                </h1>
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-5">
                        ...
                        <div class="flex flex-wrap items-end gap-3">
                            ...
                            <div class="w-[220px]">
                                ...
                                <label class="mb-2 block font-inter text-[10px] font-semibold uppercase tracking-wide text-slate-400">
                                    Revenue Period
                                </label>
            ...
            <div class="mb-7 rounded-xl border border-slate-200 bg-white p-6">

                <div class="mb-5">

                    <h2 class="font-manrope text-sm font-extrabold text-[#172033]">
                        Daily Revenue
                    </h2>
            ...
            <div class="rounded-xl border border-slate-200 bg-white">
                ...
                <div class="flex items-center justify-between border-b border-slate-100 px-6 py-5">
                    ...
                    <div class="text-right">
                        ...
                        <p class="font-inter text-[10px] uppercase tracking-wide text-slate-400">
                            Total Bills
                        </p>

                        <p class="mt-1 font-manrope text-xl font-extrabold text-[#172033]">
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        <thead>
                            ...
                            <tr class="border-b border-slate-100 bg-slate-50/60 font-inter text-[10px] font-semibold uppercase tracking-wide text-slate-400">
                            ...
                            <tr class="border-b border-slate-50 transition hover:bg-slate-50/60">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <% if ("WALK_IN".equals(bill.getBillType())) { %>
                                        ...
                                        <span class="status-badge bg-amber-50 text-amber-700">
                                            Walk-in
                                        </span>
                                ...
                                <td class="px-6 py-4 text-right font-bold text-[#172033]">
                                    Rs.
                                    <%= String.format(
                                            "%.2f",
                                            bill.getTotalAmount()
                        ...
                        <tfoot>
                            ...
                            <tr class="bg-slate-50/60">
                                ...
                                <td class="px-6 py-4 text-right font-manrope text-base font-extrabold text-[#172033]">
            ...
            <div class="mb-7">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-5">
                        ...
                        <p class="mt-2 font-manrope text-2xl font-extrabold text-emerald-700">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-5">
                        ...
                        <p class="mt-2 font-manrope text-2xl font-extrabold text-red-600">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-5">
                        ...
                        <p class="mt-2 font-manrope text-2xl font-extrabold text-amber-600">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-5">
                        ...
                        <p class="mt-2 font-manrope text-2xl font-extrabold text-blue-600">
                ...
                <div class="mt-4 flex justify-end">
                    ...
                    <div class="rounded-xl bg-[#172033] px-7 py-4 text-white">

                        <p class="font-inter text-[10px] font-semibold uppercase tracking-wide text-slate-400">
                            Total Appointments
                        </p>

                        <p class="mt-1 font-manrope text-2xl font-extrabold">
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        <%
                                ...
                                for (ReportAppointment appointment : appointments) {
                    ...
                    <p class="mt-2 font-manrope text-2xl font-extrabold text-emerald-700">
                        ...
                        <%
                            ...
                            if (summaryTreatments != null) {
                                ...
                                for (ReportTreatment item : summaryTreatments) {
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        <%
                                ...
                                for (ReportTreatment treatment : treatments) {
                        ...
                        <tfoot>
                            ...
                            <tr class="bg-slate-50/60">
                                ...
                                <td class="px-6 py-4 text-right font-inter text-xs font-bold uppercase tracking-wide text-slate-500">
